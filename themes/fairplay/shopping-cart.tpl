...
<h2 class="category_title">{l s='Shopping cart summary'}</h2>
...
<div class="order_delivery">
	...
	<ul id="delivery_address" class="address item">
		...
		{if $delivery->ic}<li class="address_ic">{$delivery->ic|escape:'htmlall':'UTF-8'}</li>{/if}
		{if $delivery->dic}<li class="address_dic">{$delivery->dic|escape:'htmlall':'UTF-8'}</li>{/if}
	...
	<ul id="invoice_address" class="address alternate_item">
		...
		{if $invoice->ic}<li class="address_ic">{$invoice->ic|escape:'htmlall':'UTF-8'}</li>{/if}
		{if $invoice->dic}<li class="address_dic">{$invoice->dic|escape:'htmlall':'UTF-8'}</li>{/if}
