...
<h3>{l s='Welcome to your account. Here you can manage your addresses and orders.'}</h3>
<ul>
  ...
  <li><a href="{$base_dir_ssl}addresses.php" title="{l s='Addresses'}"><img src="{$img_dir}icon/addrbook.gif" alt="{l s='Addresses'}" class="icon" /></a><a href="{$base_dir_ssl}addresses.php" title="{l s='Addresses'}">{l s='Your addresses'}</a></li>
	...
	{$HOOK_CUSTOMER_ACCOUNT}
		...
		<li><a href="{$base_dir}index.php?mylogout" title="{l s='log out'}"><img src="{$img_dir}icon/unavailable.gif" alt="{l s='Vouchers'}" class="icon" /></a><a href="{$base_dir}index.php?mylogout" title="{l s='log out'}">{l s='Sign out'}</a></li>
