...
<!--
	...
	{foreach from=$addresses key=k item=address}
		addresses[{$address.id_address|intval}] = new Array('{$address.company|addslashes}', '{$address.firstname|addslashes}', '{$address.lastname|addslashes}', '{$address.address1|addslashes}', '{$address.address2|addslashes}', '{$address.postcode|addslashes}', '{$address.city|addslashes}', '{$address.country|addslashes}', '{$address.state|default:''|addslashes}', '{if $address.ic}{l s='IC'}: {$address.ic|addslashes}{/if}', '{if $address.dic}{l s='DIC'}: {$address.dic|addslashes}{/if}');
	{/foreach}
-->
</script>
...
<form action="{$base_dir_ssl}order.php" method="post">
	<div class="addresses">
		...
		<ul class="address item" id="address_delivery">
			...
			<li class="address_ic"></li>
			<li class="address_dic"></li>
