...
function updateAddressDisplay(addressType)
{
	...
	$('ul#address_' + addressType + ' li.address_ic').html(addresses[idAddress][9]);
	if(addresses[idAddress][0] == '')
		$('ul#address_' + addressType + ' li.address_ic').hide();
	else
		$('ul#address_' + addressType + ' li.address_ic').show();
	$('ul#address_' + addressType + ' li.address_dic').html(addresses[idAddress][10]);
	if(addresses[idAddress][0] == '')
		$('ul#address_' + addressType + ' li.address_dic').hide();
	else
		$('ul#address_' + addressType + ' li.address_dic').show();
