...
<h2 class="category_title">{l s='Order summary' mod='bankwire'}</h2>
...
<p class="cart_navigation">
	<a href="{$base_dir_ssl}order.php?step=1" class="button_large">{l s='Other payment methods' mod='bankwire'}</a>
	<input type="submit" name="submit" value="{l s='I confirm my order' mod='bankwire'}" class="button" style="float: right;" />
</p>
</form>
{/if}
</div>
