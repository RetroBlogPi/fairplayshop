...
<div id="search_block_top">
	...
	<p>
		...
		<input type="text" id="search_query" name="search_query" value="{if isset($smarty.get.search_query)}{$smarty.get.search_query|htmlentities:$ENT_QUOTES:'utf-8'|stripslashes}{else}{l s='Vyhledávání' mod='blocksearch'}{/if}" onfocus="javascript:if(this.value=='{l s='Vyhledávání' mod='blocksearch'}')this.value='';" onblur="javascript:if(this.value=='')this.value='{l s='Vyhledávání' mod='blocksearch'}';" />
