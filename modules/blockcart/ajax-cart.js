...
var ajaxCart = {
	...
	overrideButtonsInThePage : function(){
		...
		$('body#product p#add_to_cart input').unbind('click').click(function(){
		  //VE.cz - size
			...
			ajaxCart.add( $('#product_page_product_id').val(), $('#idCombination').val(), true, null, $('#quantity_wanted').val(), null, $('#quantity_wanted_w').val(), $('#quantity_wanted_h').val(), $('#customsize').val());
			return false;
		});
	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist, sizew, sizeh,customsize){
		...
		$.ajax({
			...
			//VE.cz
			data: 'add&ajax=true&qty=' + ( (quantity && quantity != null) ? quantity : '1') + '&sizew=' + ( (sizew && sizew != null) ? sizew : '0') + '&sizeh=' + ( (sizeh && sizeh != null) ? sizeh : '0') + '&customsize=' + ( (customsize && customsize != null) ? customsize : '0') + '&id_product=' + idProduct + '&token=' + static_token + ( (parseInt(idCombination) && idCombination != null) ? '&ipa=' + parseInt(idCombination): ''),
			success: function(jsonData)
			{
	...
	updateProductQuantity : function (product, quantity) {
		$('dt#cart_block_product_' + product.id + (product.idCombination ? '_' + product.idCombination : '') + ' .quantity').fadeTo('fast', 0, function() {
		  if(product.sizew>0 && product.sizeh>0) $(this).text(product.sizew+'x'+product.sizeh);
			else $(this).text(quantity);
			...
			if (this.id != undefined)
			{
				...
				if($('#cart_block dt#cart_block_product_'+ domIdProduct ).length == 0)
				{
					...
					var content =  '<dt class="hidden" id="cart_block_product_' + domIdProduct + '">';
						 if(this.sizew>0 && this.sizeh>0) content += '<span class="quantity-formated"><span class="quantity">' + this.sizew + 'x'+this.sizeh+'</span></span>';
             else content += '<span class="quantity-formated"><span class="quantity">' + this.quantity + '</span>x</span>';
