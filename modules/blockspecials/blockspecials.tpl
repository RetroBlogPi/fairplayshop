...
{if $special}
		<ul class="products">
			<li class="product_image">
				<a href="{$special.link}"><img src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'medium')}" alt="{$special.legend}" height="{$mediumSize.height}" width="{$mediumSize.width}" title="{$special.name}" /></a>
			</li>
			<li>
				<h5><a href="{$special.link}" title="{$special.name}">{$special.name}</a></h5>
