<?php /* Smarty version 2.6.20, created on 2012-04-23 13:03:02
         compiled from /home/www/fairplayshop.cz/www/modules/blocktags/blocktags.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/www/fairplayshop.cz/www/modules/blocktags/blocktags.tpl', 3, false),array('modifier', 'urlencode', '/home/www/fairplayshop.cz/www/modules/blocktags/blocktags.tpl', 7, false),)), $this); ?>
<!-- Block tags module -->
...
" class="<?php echo $this->_tpl_vars['tag']['class']; ?>
 <?php if (($this->_foreach['myLoop']['iteration'] == $this->_foreach['myLoop']['total'])): ?>last_item<?php elseif (($this->_foreach['myLoop']['iteration'] <= 1)): ?>first_item<?php else: ?>item<?php endif; ?>"><?php echo $this->_tpl_vars['tag']['name']; ?>
</a>
