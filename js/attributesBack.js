function fillCombinaison(wholesale_price, price_impact, price_impact_D1, price_impact_D2, price_impact_D3, weight_impact, reference, supplier_reference, ean, quantity, image, old_attr, id_product_attribute, default_attribute, eco_tax, location)
{
	init_elems();
	...
	getE('attribute_price').value = Math.abs(price_impact);
        getE('attribute_price_d1').value = Math.abs(price_impact_D1);
        getE('attribute_price_d2').value = Math.abs(price_impact_D2);
        getE('attribute_price_d3').value = Math.abs(price_impact_D3);
	...
	if (price_impact_D1 < 0)
	{
		getE('attribute_price_impact_d1').options[getE('attribute_price_impact_d1').selectedIndex].value = -1;
		getE('attribute_price_impact_d1').selectedIndex = 2;
	}
	else if (!price_impact_D1)
	{
		getE('attribute_price_impact_d1').options[getE('attribute_price_impact_d1').selectedIndex].value = 0;
		getE('attribute_price_impact_d1').selectedIndex = 0;
	}
	else if (price_impact_D1 > 0)
	{
		getE('attribute_price_impact_d1').options[getE('attribute_price_impact_d1').selectedIndex].value = 1;
		getE('attribute_price_impact_d1').selectedIndex = 1;
	}

	if (price_impact_D2 < 0)
	{
		getE('attribute_price_impact_d2').options[getE('attribute_price_impact_d2').selectedIndex].value = -1;
		getE('attribute_price_impact_d2').selectedIndex = 2;
	}
	else if (!price_impact_D2)
	{
		getE('attribute_price_impact_d2').options[getE('attribute_price_impact_d2').selectedIndex].value = 0;
		getE('attribute_price_impact_d2').selectedIndex = 0;
	}
	else if (price_impact_D2 > 0)
	{
		getE('attribute_price_impact_d2').options[getE('attribute_price_impact_d2').selectedIndex].value = 1;
		getE('attribute_price_impact_d2').selectedIndex = 1;
	}

	if (price_impact_D3 < 0)
	{
		getE('attribute_price_impact_d3').options[getE('attribute_price_impact_d3').selectedIndex].value = -1;
		getE('attribute_price_impact_d3').selectedIndex = 2;
	}
	else if (!price_impact_D3)
	{
		getE('attribute_price_impact_d3').options[getE('attribute_price_impact_d3').selectedIndex].value = 0;
		getE('attribute_price_impact_d3').selectedIndex = 0;
	}
	else if (price_impact_D3 > 0)
	{
		getE('attribute_price_impact_d3').options[getE('attribute_price_impact_d3').selectedIndex].value = 1;
		getE('attribute_price_impact_d3').selectedIndex = 1;
	}
