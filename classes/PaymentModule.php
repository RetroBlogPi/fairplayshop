	...
	*/
	...
	function validateOrder($id_cart, $id_order_state, $amountPaid, $paymentMethod = 'Unknown', $message = NULL, $extraVars = array(), $currency_special = NULL, $dont_touch_amount = false)
	{
        ...
        $message_email = "";
          ...
          {
						Mail::Send(intval($order->id_lang), 'order_conf', 'Vase objednavka c.: '.$order->id, $data, $customer->email, $customer->firstname.' '.$customer->lastname, NULL, NULL, $fileAttachment);
