...
class		Address extends ObjectModel
{
	...
	/** @var boolean True if address is Personal */
	public 		$id_type = 0;
	...
	protected	$fieldsValidate = array('id_customer' => 'isNullOrUnsignedId', 'id_manufacturer' => 'isNullOrUnsignedId',
										...
										'alias' => 'isGenericName','former_alias' => 'isGenericName', 'company' => 'isGenericName', 'id_type' => 'isBool', 'ic' => 'isGenericName', 'dic' => 'isGenericName', 'lastname' => 'isName',
    ...
    $fields['id_type'] = pSQL($this->id_type);
		$fields['ic'] = pSQL($this->ic);
		$fields['dic'] = pSQL($this->dic);				
